...
describe("formül — makalede tablo hâlinde geçen diğer hücreler", () => {
  it("4096² RGBA16F mip'li → 178.956.968 bayt (170,67 MiB)", () => {
  ...
  it("4096² BC1/ETC1 mip'li → 11.184.824 bayt (10,67 MiB)", () => {
  ...
  it("2048² demo dokusu: BC7 5.592.432 · BC1 2.796.216 · RGBA8 mipsiz 16.777.216", () => {
  ...
  it("alfa kanalı rafı ikiye katlar: 4K BC1 10,67 MiB → BC3 21,33 MiB", () => {
  ...
  it("levels verilirse mipmaps yok sayılır; sıkıştırılmışta hiçbir seviye bloktan küçük olamaz", () => {
    expect(estimateTextureMemory(64, 64, "RGBA8", { mipmaps: true, levels: 1 })).toBe(64 * 64 * 4);
    // 4×4 mip ile 1×1 mip aynı: ikisi de tek blok = 16 bayt
